-- Etap11. Odcinek: Tablice tekstowe
...
-- OFFSET(), ORDINAL() pobieraja z tablicy element o danym indeksie
-- w OFFSET numerowanie tablicy od 0
-- w ODRINAL numerowanie tablicy od 1
