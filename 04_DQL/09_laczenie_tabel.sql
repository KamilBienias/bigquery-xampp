-- Etap8. Odcinek: Laczenie tabel - INNER lEFT RIGHT FULL CROSS JOIN
...
-- wiersze ktore sie powtarzaja w t1 i t2
-- bo JOIN to domyslnie INNER JOIN
SELECT
  *
FROM
  DQL.employees AS t1
...
-- iloczyn kartezjanski, nie podajemy ON
-- Robi kazdy z kazdym
SELECT
  *
FROM
