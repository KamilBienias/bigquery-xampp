-- Etap8. Odcinki: od Instrukcja SELECT do Filtrowanie istrucjka WHERE cz.2
...
-- SELECT ALL wybiera wszystkie wiersze z tabeli
-- ale on jest ustawiony domyslnie jako zwykly SELECT
-- SELECT DISTINCT wybiera unikalne wiersze
SELECT
  DISTINCT *
FROM
  DQL.bike;
...
-- SELECT ... REPLACE(...)
-- zamienia czas trwania podrozy z sekund na minuty
SELECT
...
FROM
  DQL.bike
WHERE
  duration / 60 > 300; --WHERE dziala na kolumnie oryginalnej a nie po REPLACE
