-- Etap10. Odcinek: Wyrazenie COALESCE
...
-- tam gdzie jest null to zwraca podana wartosc
SELECT
    *,
    COALESCE(is_purchased_ad_1, 'brak') AS "BRAK"
FROM
    functions.coal;

-- wyswietli czy uzytkownik kliknal w ktorakolwiek z reklam
SELECT
  *,
