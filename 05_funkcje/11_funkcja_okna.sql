-- Etap9. Odcinek: Funkcje okna OVER()
...
-- To jest domyslne ustawienie dla wierszy,
-- czyli z dolu nieograniczona suma az do obecnego wiersza (nie chcemy nastepnego)
...
--  srednia obecnego wiersza i 4 poprzedzajacych
